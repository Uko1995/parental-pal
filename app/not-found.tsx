  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-[#FFEACF]/30 via-white to-[#FFEACF]/30 flex flex-col items-center justify-center px-4">
      <div className="max-w-lg w-full text-center">
        ...
        <div className="space-y-4 mb-8">
          <div className="grid grid-cols-2 gap-3">
            <Link
              href="/"
              className="block border-2 border-[#90AC19] text-[#90AC19] hover:bg-[#90AC19] hover:text-white py-2 px-4 rounded-lg font-semibold transition-all duration-300 text-sm text-center"
            >
              Try Again
            </Link>
            <Link
              href="/"
              className="block border-2 border-[#E8931A] text-[#E8931A] hover:bg-[#E8931A] hover:text-white py-2 px-4 rounded-lg font-semibold transition-all duration-300 text-sm text-center"
            >
              Go to Homepage
            </Link>
          </div>
      ...
      <div className="fixed top-0 left-0 w-full h-full overflow-hidden pointer-events-none -z-10">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-[#90AC19]/5 rounded-full blur-3xl animate-pulse" />
        <div
