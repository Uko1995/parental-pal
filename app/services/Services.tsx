...
import { SERVICE_CONSULT_WHATSAPP_URL } from "@/lib/service-page-content";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {services.map((service) => {
            ...
            const href = getPublicServiceHref(service, promoSeason);
              ...
              >
                ...
                <div className="p-6 md:p-7 flex flex-col flex-1 min-h-0">
                  ...
                  <div className="pt-4 border-t border-gray-100 mt-auto">
                    <Link
                      href={href}
                      className="flex items-center justify-center gap-2 bg-[#90AC19] hover:bg-[#7A9216] text-white text-center py-3 px-6 rounded-xl font-semibold transition-all duration-300 shadow-md hover:shadow-lg"
                    >
                      Learn more
                      <svg
                        className="w-4 h-4"
