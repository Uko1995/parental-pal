...
export default function Contact() {
  ...
  const socialMedia = [
    {
      name: "Facebook",
      url: "https://facebook.com/parentalpal",
      icon: (
    ...
    {
      name: "Twitter",
      url: "https://twitter.com/parentalpal",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Instagram",
      url: "https://instagram.com/parentalpal",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987c6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.348-1.051-2.348-2.348c0-1.297 1.051-2.348 2.348-2.348c1.297 0 2.348 1.051 2.348 2.348C10.797 15.937 9.746 16.988 8.449 16.988zM12.017 7.129c-2.79 0-5.05 2.26-5.05 5.05c0 2.79 2.26 5.05 5.05 5.05c2.79 0 5.05-2.26 5.05-5.05C17.067 9.389 14.807 7.129 12.017 7.129z" />
        </svg>
      ),
    ...
    {
      name: "LinkedIn",
      url: "https://linkedin.com/company/parentalpal",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "YouTube",
      url: "https://youtube.com/parentalpal",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex space-x-4">
                {socialMedia.map((social, index) => (
                  <a
                    ...
                    className={`p-3 bg-white rounded-full shadow-md transition-all duration-300 text-gray-600 ${social.color} hover:scale-110 hover:shadow-lg`}
